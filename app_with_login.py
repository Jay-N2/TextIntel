...
authenticator = stauth.Authenticate(
    names, usernames, hashed_passwords, "auth", "abcdef", cookie_expiry_days=30)
...
if st.session_state['authentication_status']:
    ...
    st.subheader("by Jay Nadkarni and Sahil Nannaware")
    ...
    authenticator.logout("  Login Again as a Different User", "sidebar")
    st.sidebar.write(f'''
...
''', unsafe_allow_html=True)
    ...
    if option == 'Home':
        st.write(
            """
					## Project Description
The Text Analysis Tool developed by Jay Nadkarni and Sahil Nannaware is a comprehensive web application designed to empower users with the capabilities of text analytics. 
...
### Please enjoy using our application!
    ...
    # N-Gram Analysis Option
        ...
        st.subheader(
            "This section displays the most commonly occuring N-Grams in your Data")
